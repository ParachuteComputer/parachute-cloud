/**
 * Shared live-query frame corpus — the SINGLE source of truth for the wire
 * payloads both transports must agree on. Imported by BOTH the SSE and the WS
 * parity tests so "WS payload === SSE `data:` body" is pinned against one fixture
 * (WS-hibernation migration, docs/live-query-ws.md).
 *
