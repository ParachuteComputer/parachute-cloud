...
const STYLE = `
  :root{
    /* grounds + ink */
    --bg:#f4f6f1;--card:#fff;--ink:#2b332a;--muted:#6a7566;--line:#dde3d6;
    /* near-white utility fills (the recurring greys, now named) */
    --field:#fcfdfb;--fill:#eef0ea;--fill-hover:#e4e8dd;--fill-2:#eff3ea;--code-bg:#eef1ea;
    /* accent family (interactive/brand hue): --accent = white-text button bg,
       --accent-strong = hover/gradient-deep, --accent-link = text-on-light,
       --accent-bright = large decorative, --accent-soft* = soft badge bg/border/ink */
    --accent:#5f7a57;--accent-strong:#4c6547;--accent-link:#4c6547;--accent-bright:#5f7a57;
    --accent-soft:#eaf2e6;--accent-soft-line:#cfe0c4;--accent-soft-ink:#4c6547;
    /* semantic */
    --danger:#a5372b;--warn-bg:#faeee9;--warn-line:#e6c7ba;--warn-ink:#8a3a2a;
    --dot-off:#b9c2ad;--mark-line:#c3ccb8;
  ...
  *{box-sizing:border-box}
  ...
  .brand{font-family:"Instrument Serif",Georgia,serif;font-size:1.15rem;color:var(--accent-link);letter-spacing:.01em;margin:0 0 1.5rem;text-align:center}
  ...
  .card{background:var(--card);border:1px solid var(--line);border-radius:var(--radius-card);padding:1.6rem;margin-bottom:1.1rem}
  label{display:block;font-size:.82rem;font-weight:600;margin:.85rem 0 .3rem;color:var(--ink)}
  input[type=email],input[type=password],input[type=text]{width:100%;padding:.6rem .7rem;border:1px solid var(--line);border-radius:var(--radius-control);font-size:1rem;background:var(--field);font-family:inherit}
  input:focus{outline:2px solid var(--accent);outline-offset:0;border-color:var(--accent)}
  button{font-size:1rem;font-family:inherit;padding:.62rem 1rem;border-radius:var(--radius-control);border:0;cursor:pointer}
  .primary{background:var(--accent);color:#fff;width:100%;margin-top:1.1rem;font-weight:600}
  .primary:hover{background:var(--accent-strong)}
  .row{display:flex;gap:.6rem;margin-top:1.1rem}
  .row button{flex:1}
  .deny{background:var(--fill);color:var(--ink)}
  ...
  .vault{border:1px solid var(--line);border-radius:var(--radius-panel);padding:1rem 1.1rem;margin-bottom:.9rem;background:var(--field)}
  ...
  .secondary{background:var(--fill);color:var(--ink);width:100%;margin-top:1.1rem;font-weight:600}
  ...
  .codegrid li{background:var(--fill-2);border:1px solid var(--line);border-radius:var(--radius-code);padding:.45rem;text-align:center;font-family:ui-monospace,Menlo,monospace;font-size:.92rem;letter-spacing:.03em}
  ...
  .secret{font-family:ui-monospace,Menlo,monospace;font-size:1rem;letter-spacing:.14em;word-break:break-all;background:var(--code-bg);border:1px solid var(--line);border-radius:var(--radius-chip);padding:.55rem .7rem;text-align:center}
  .biginput{font-size:1.15rem;padding:.75rem .8rem}
  .chips{display:flex;flex-wrap:wrap;gap:.45rem;margin-top:.4rem}
  .chips input{position:absolute;opacity:0;pointer-events:none}
  .chips label{display:inline-block;margin:0;padding:.4rem .85rem;border:1px solid var(--line);border-radius:var(--pill);font-size:.88rem;font-weight:500;cursor:pointer;background:var(--field);color:var(--ink)}
  ...
  .copybtn{flex:none;background:var(--fill);border:1px solid var(--line);border-radius:var(--radius-chip);padding:.4rem .85rem;font-size:.85rem;font-weight:600;color:var(--accent-link)}
  ...
  .lead p{margin:0}
  .pricepill{display:inline-block;background:var(--accent-soft);border:1px solid var(--accent-soft-line);color:var(--accent-soft-ink);padding:.32rem .7rem;border-radius:var(--pill);font-size:.86rem;font-weight:600}
  .secnav{display:flex;flex-wrap:wrap;gap:.4rem;margin:0 0 1.3rem}
  .secnav a{padding:.3rem .8rem;border-radius:var(--pill);background:var(--fill-2);color:var(--accent-link);text-decoration:none;font-size:.88rem;font-weight:600;white-space:nowrap}
  ...
  .creating.ready .creating-orb{animation:none;background:var(--accent);box-shadow:0 0 0 .4rem rgba(95,122,87,.14)}
