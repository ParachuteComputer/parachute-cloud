...
cd workers/vault && bun run typecheck && bun x vitest run    # 118+1 todo under workerd
cd workers/identity && bun run typecheck && bun x vitest run # 211
